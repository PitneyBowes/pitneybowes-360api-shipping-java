...
class AddressApiTest {
     ...
     */
    @Test
    void addressSuggestTest() {
        AddressSuggestRequest addressSuggestRequest = null;

        AddressSuggestResponse response = api.addressSuggest(addressSuggestRequest);
    ...
    void addressValidateTest() {
        AddressValidateRequest addressValidateRequest = null;
        Boolean minimalAddressValidation = null;

        AddressValidateResponse response = api.addressValidate(addressValidateRequest, minimalAddressValidation);
