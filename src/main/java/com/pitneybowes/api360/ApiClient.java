...
import com.pitneybowes.api360.auth.Authentication;
import com.pitneybowes.api360.auth.HttpBasicAuth;
import com.pitneybowes.api360.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://api-sandbox.sendpro360.pitneybowes.com/shipping";
    ...
    public void configureBearerAuth(String clientId, String clientSecret) {

        HttpBasicAuth basicAuth = (HttpBasicAuth) authentications.get("basicAuth");
        basicAuth.setUsername(clientId);
        basicAuth.setPassword(clientSecret);

        this.tokenProvider = new TokenProvider(this.restTemplate, this.basePath.replaceAll("shipping", "auth"), basicAuth.getUsername(), basicAuth.getPassword());
        String bearerToken = tokenProvider.fetchBearerToken();
        HttpBearerAuth bearerAuth = (HttpBearerAuth) this.getAuthentication("bearerAuth");
        ...
        while (attempts < maxAttemptsForRetry) {
            try {
                ...
                if (ex instanceof HttpServerErrorException
                    ...
                    && ((HttpClientErrorException) ex).getStatusCode().equals(HttpStatus.UNAUTHORIZED)) {
                    attempts++;
