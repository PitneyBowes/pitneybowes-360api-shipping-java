 ...
 */
@JsonPropertyOrder({
  ShipmentDomesticParcel.JSON_PROPERTY_HEIGHT,
  ShipmentDomesticParcel.JSON_PROPERTY_LENGTH,
  ShipmentDomesticParcel.JSON_PROPERTY_WIDTH,
  ShipmentDomesticParcel.JSON_PROPERTY_DIM_UNIT,
  ShipmentDomesticParcel.JSON_PROPERTY_WEIGHT_UNIT,
  ShipmentDomesticParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("shipmentDomestic_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class ShipmentDomesticParcel {
  ...
  public ShipmentDomesticParcel() {
  }

  public ShipmentDomesticParcel height(BigDecimal height) {
  ...
  public ShipmentDomesticParcel length(BigDecimal length) {
  ...
  public ShipmentDomesticParcel width(BigDecimal width) {
  ...
  public ShipmentDomesticParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public ShipmentDomesticParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public ShipmentDomesticParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    ShipmentDomesticParcel shipmentDomesticParcel = (ShipmentDomesticParcel) o;
    return Objects.equals(this.height, shipmentDomesticParcel.height) &&
        Objects.equals(this.length, shipmentDomesticParcel.length) &&
        Objects.equals(this.width, shipmentDomesticParcel.width) &&
        Objects.equals(this.dimUnit, shipmentDomesticParcel.dimUnit) &&
        Objects.equals(this.weightUnit, shipmentDomesticParcel.weightUnit) &&
        Objects.equals(this.weight, shipmentDomesticParcel.weight);
  }
