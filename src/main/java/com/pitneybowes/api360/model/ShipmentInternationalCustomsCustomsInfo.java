 ...
 */
@JsonPropertyOrder({
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_REASON_FOR_EXPORT,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_CUSTOMS_DECLARED_VALUE,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_CURRENCY_CODE,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_E_E_L_P_F_C,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_CERTIFICATE_NUMBER,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_COMMENTS,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_FROM_CUSTOMS_REFERENCE,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_IMPORTER_CUSTOMS_REFERENCE,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_INVOICE_NUMBER,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_LICENSE_NUMBER,
  ShipmentInternationalCustomsCustomsInfo.JSON_PROPERTY_SDR_VALUE
})
@JsonTypeName("ShipmentInternational_customs_customsInfo")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class ShipmentInternationalCustomsCustomsInfo {
  /**
  ...
  public ShipmentInternationalCustomsCustomsInfo() {
  }

  public ShipmentInternationalCustomsCustomsInfo reasonForExport(ReasonForExportEnum reasonForExport) {
  ...
  public ShipmentInternationalCustomsCustomsInfo customsDeclaredValue(BigDecimal customsDeclaredValue) {
  ...
  public ShipmentInternationalCustomsCustomsInfo currencyCode(String currencyCode) {
  ...
  public ShipmentInternationalCustomsCustomsInfo EELPFC(String EELPFC) {
  ...
  public ShipmentInternationalCustomsCustomsInfo certificateNumber(String certificateNumber) {
  ...
  public ShipmentInternationalCustomsCustomsInfo comments(String comments) {
  ...
  public ShipmentInternationalCustomsCustomsInfo fromCustomsReference(String fromCustomsReference) {
  ...
  public ShipmentInternationalCustomsCustomsInfo importerCustomsReference(String importerCustomsReference) {
  ...
  public ShipmentInternationalCustomsCustomsInfo invoiceNumber(String invoiceNumber) {
  ...
  public ShipmentInternationalCustomsCustomsInfo licenseNumber(String licenseNumber) {
  ...
  public ShipmentInternationalCustomsCustomsInfo sdrValue(BigDecimal sdrValue) {
  ...
  public boolean equals(Object o) {
    ...
    ShipmentInternationalCustomsCustomsInfo shipmentInternationalCustomsCustomsInfo = (ShipmentInternationalCustomsCustomsInfo) o;
    return Objects.equals(this.reasonForExport, shipmentInternationalCustomsCustomsInfo.reasonForExport) &&
        Objects.equals(this.customsDeclaredValue, shipmentInternationalCustomsCustomsInfo.customsDeclaredValue) &&
        Objects.equals(this.currencyCode, shipmentInternationalCustomsCustomsInfo.currencyCode) &&
        Objects.equals(this.EELPFC, shipmentInternationalCustomsCustomsInfo.EELPFC) &&
        Objects.equals(this.certificateNumber, shipmentInternationalCustomsCustomsInfo.certificateNumber) &&
        Objects.equals(this.comments, shipmentInternationalCustomsCustomsInfo.comments) &&
        Objects.equals(this.fromCustomsReference, shipmentInternationalCustomsCustomsInfo.fromCustomsReference) &&
        Objects.equals(this.importerCustomsReference, shipmentInternationalCustomsCustomsInfo.importerCustomsReference) &&
        Objects.equals(this.invoiceNumber, shipmentInternationalCustomsCustomsInfo.invoiceNumber) &&
        Objects.equals(this.licenseNumber, shipmentInternationalCustomsCustomsInfo.licenseNumber) &&
        Objects.equals(this.sdrValue, shipmentInternationalCustomsCustomsInfo.sdrValue);
  }
