 ...
 */
@JsonPropertyOrder({
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_REASON_FOR_EXPORT,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_CUSTOMS_DECLARED_VALUE,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_CURRENCY_CODE,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_E_E_L_P_F_C,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_CERTIFICATE_NUMBER,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_COMMENTS,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_FROM_CUSTOMS_REFERENCE,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_IMPORTER_CUSTOMS_REFERENCE,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_INVOICE_NUMBER,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_LICENSE_NUMBER,
  MultipieceInternationalShipmentRequestCustomsCustomsInfo.JSON_PROPERTY_SDR_VALUE
})
@JsonTypeName("MultipieceInternationalShipmentRequest_customs_customsInfo")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class MultipieceInternationalShipmentRequestCustomsCustomsInfo {
  /**
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo() {
  }

  public MultipieceInternationalShipmentRequestCustomsCustomsInfo reasonForExport(ReasonForExportEnum reasonForExport) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo customsDeclaredValue(BigDecimal customsDeclaredValue) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo currencyCode(String currencyCode) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo EELPFC(String EELPFC) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo certificateNumber(String certificateNumber) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo comments(String comments) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo fromCustomsReference(String fromCustomsReference) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo importerCustomsReference(String importerCustomsReference) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo invoiceNumber(String invoiceNumber) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo licenseNumber(String licenseNumber) {
  ...
  public MultipieceInternationalShipmentRequestCustomsCustomsInfo sdrValue(BigDecimal sdrValue) {
  ...
  public boolean equals(Object o) {
    ...
    MultipieceInternationalShipmentRequestCustomsCustomsInfo multipieceInternationalShipmentRequestCustomsCustomsInfo = (MultipieceInternationalShipmentRequestCustomsCustomsInfo) o;
    return Objects.equals(this.reasonForExport, multipieceInternationalShipmentRequestCustomsCustomsInfo.reasonForExport) &&
        Objects.equals(this.customsDeclaredValue, multipieceInternationalShipmentRequestCustomsCustomsInfo.customsDeclaredValue) &&
        Objects.equals(this.currencyCode, multipieceInternationalShipmentRequestCustomsCustomsInfo.currencyCode) &&
        Objects.equals(this.EELPFC, multipieceInternationalShipmentRequestCustomsCustomsInfo.EELPFC) &&
        Objects.equals(this.certificateNumber, multipieceInternationalShipmentRequestCustomsCustomsInfo.certificateNumber) &&
        Objects.equals(this.comments, multipieceInternationalShipmentRequestCustomsCustomsInfo.comments) &&
        Objects.equals(this.fromCustomsReference, multipieceInternationalShipmentRequestCustomsCustomsInfo.fromCustomsReference) &&
        Objects.equals(this.importerCustomsReference, multipieceInternationalShipmentRequestCustomsCustomsInfo.importerCustomsReference) &&
        Objects.equals(this.invoiceNumber, multipieceInternationalShipmentRequestCustomsCustomsInfo.invoiceNumber) &&
        Objects.equals(this.licenseNumber, multipieceInternationalShipmentRequestCustomsCustomsInfo.licenseNumber) &&
        Objects.equals(this.sdrValue, multipieceInternationalShipmentRequestCustomsCustomsInfo.sdrValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipieceInternationalShipmentRequestCustomsCustomsInfo {\n");
