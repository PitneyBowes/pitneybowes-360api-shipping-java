 ...
 */
@JsonPropertyOrder({
  RateShopParcel.JSON_PROPERTY_HEIGHT,
  RateShopParcel.JSON_PROPERTY_LENGTH,
  RateShopParcel.JSON_PROPERTY_WIDTH,
  RateShopParcel.JSON_PROPERTY_DIM_UNIT,
  RateShopParcel.JSON_PROPERTY_WEIGHT_UNIT,
  RateShopParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("rateShop_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class RateShopParcel {
  ...
  public RateShopParcel() {
  }

  public RateShopParcel height(BigDecimal height) {
  ...
  public RateShopParcel length(BigDecimal length) {
  ...
  public RateShopParcel width(BigDecimal width) {
  ...
  public RateShopParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public RateShopParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public RateShopParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    RateShopParcel rateShopParcel = (RateShopParcel) o;
    return Objects.equals(this.height, rateShopParcel.height) &&
        Objects.equals(this.length, rateShopParcel.length) &&
        Objects.equals(this.width, rateShopParcel.width) &&
        Objects.equals(this.dimUnit, rateShopParcel.dimUnit) &&
        Objects.equals(this.weightUnit, rateShopParcel.weightUnit) &&
        Objects.equals(this.weight, rateShopParcel.weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class RateShopParcel {\n");
