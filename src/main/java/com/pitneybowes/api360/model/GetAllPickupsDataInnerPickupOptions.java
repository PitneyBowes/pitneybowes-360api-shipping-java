 ...
 */
@JsonPropertyOrder({
  GetAllPickupsDataInnerPickupOptions.JSON_PROPERTY_PICKUP_START_DATE_TIME,
  GetAllPickupsDataInnerPickupOptions.JSON_PROPERTY_PICKUP_END_DATE_TIME,
  GetAllPickupsDataInnerPickupOptions.JSON_PROPERTY_OVERWEIGHT,
  GetAllPickupsDataInnerPickupOptions.JSON_PROPERTY_CARRIER_TYPE
})
@JsonTypeName("getAllPickups_data_inner_pickupOptions")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class GetAllPickupsDataInnerPickupOptions {
  ...
  public GetAllPickupsDataInnerPickupOptions() {
  }

  public GetAllPickupsDataInnerPickupOptions pickupStartDateTime(String pickupStartDateTime) {
  ...
  public GetAllPickupsDataInnerPickupOptions pickupEndDateTime(String pickupEndDateTime) {
  ...
  public GetAllPickupsDataInnerPickupOptions overweight(BigDecimal overweight) {
  ...
  public GetAllPickupsDataInnerPickupOptions carrierType(String carrierType) {
  ...
  public boolean equals(Object o) {
    ...
    GetAllPickupsDataInnerPickupOptions getAllPickupsDataInnerPickupOptions = (GetAllPickupsDataInnerPickupOptions) o;
    return Objects.equals(this.pickupStartDateTime, getAllPickupsDataInnerPickupOptions.pickupStartDateTime) &&
        Objects.equals(this.pickupEndDateTime, getAllPickupsDataInnerPickupOptions.pickupEndDateTime) &&
        Objects.equals(this.overweight, getAllPickupsDataInnerPickupOptions.overweight) &&
        Objects.equals(this.carrierType, getAllPickupsDataInnerPickupOptions.carrierType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAllPickupsDataInnerPickupOptions {\n");
