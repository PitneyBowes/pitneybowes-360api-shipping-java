 ...
 */
@JsonPropertyOrder({
  BPODDownloadRequest.JSON_PROPERTY_SHIPMENT_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class BPODDownloadRequest {
  public static final String JSON_PROPERTY_SHIPMENT_IDS = "shipmentIds";
  private List<String> shipmentIds = new ArrayList<>();

  public BPODDownloadRequest() {
  }

  public BPODDownloadRequest shipmentIds(List<String> shipmentIds) {
    
    this.shipmentIds = shipmentIds;
    return this;
  }

  public BPODDownloadRequest addShipmentIdsItem(String shipmentIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    BPODDownloadRequest bpODDownloadRequest = (BPODDownloadRequest) o;
    return Objects.equals(this.shipmentIds, bpODDownloadRequest.shipmentIds);
  }
