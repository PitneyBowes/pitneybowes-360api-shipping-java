 ...
 */
@JsonPropertyOrder({
  SchedulePickupFedexRequestPickupOptions.JSON_PROPERTY_PICKUP_START_DATE_TIME,
  SchedulePickupFedexRequestPickupOptions.JSON_PROPERTY_PICKUP_END_DATE_TIME,
  SchedulePickupFedexRequestPickupOptions.JSON_PROPERTY_OVERWEIGHT,
  SchedulePickupFedexRequestPickupOptions.JSON_PROPERTY_CARRIER_TYPE
})
@JsonTypeName("schedulePickupFedexRequest_pickupOptions")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class SchedulePickupFedexRequestPickupOptions {
  ...
  public SchedulePickupFedexRequestPickupOptions() {
  }

  public SchedulePickupFedexRequestPickupOptions pickupStartDateTime(String pickupStartDateTime) {
  ...
  public SchedulePickupFedexRequestPickupOptions pickupEndDateTime(String pickupEndDateTime) {
  ...
  public SchedulePickupFedexRequestPickupOptions overweight(BigDecimal overweight) {
  ...
  public SchedulePickupFedexRequestPickupOptions carrierType(String carrierType) {
  ...
  public boolean equals(Object o) {
    ...
    SchedulePickupFedexRequestPickupOptions schedulePickupFedexRequestPickupOptions = (SchedulePickupFedexRequestPickupOptions) o;
    return Objects.equals(this.pickupStartDateTime, schedulePickupFedexRequestPickupOptions.pickupStartDateTime) &&
        Objects.equals(this.pickupEndDateTime, schedulePickupFedexRequestPickupOptions.pickupEndDateTime) &&
        Objects.equals(this.overweight, schedulePickupFedexRequestPickupOptions.overweight) &&
        Objects.equals(this.carrierType, schedulePickupFedexRequestPickupOptions.carrierType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pickupStartDateTime, pickupEndDateTime, overweight, carrierType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SchedulePickupFedexRequestPickupOptions {\n");
