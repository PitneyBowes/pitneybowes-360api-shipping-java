 ...
 */
@JsonPropertyOrder({
  ManifestCompactResponse.JSON_PROPERTY_MANIFEST_DOCUMENTS,
  ManifestCompactResponse.JSON_PROPERTY_MANIFEST_I_D,
  ManifestCompactResponse.JSON_PROPERTY_MANIFEST_TRACKING_NUMBER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class ManifestCompactResponse {
  ...
  public ManifestCompactResponse() {
  }

  public ManifestCompactResponse manifestDocuments(List<ManifestCompactResponseManifestDocumentsInner> manifestDocuments) {
    
    this.manifestDocuments = manifestDocuments;
    return this;
  }

  public ManifestCompactResponse addManifestDocumentsItem(ManifestCompactResponseManifestDocumentsInner manifestDocumentsItem) {
  ...
  public ManifestCompactResponse manifestID(String manifestID) {
  ...
  public ManifestCompactResponse manifestTrackingNumber(String manifestTrackingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ManifestCompactResponse manifestCompactResponse = (ManifestCompactResponse) o;
    return Objects.equals(this.manifestDocuments, manifestCompactResponse.manifestDocuments) &&
        Objects.equals(this.manifestID, manifestCompactResponse.manifestID) &&
        Objects.equals(this.manifestTrackingNumber, manifestCompactResponse.manifestTrackingNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(manifestDocuments, manifestID, manifestTrackingNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ManifestCompactResponse {\n");
