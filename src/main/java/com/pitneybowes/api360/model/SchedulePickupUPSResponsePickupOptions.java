 ...
 */
@JsonPropertyOrder({
  SchedulePickupUPSResponsePickupOptions.JSON_PROPERTY_PICKUP_START_DATE_TIME,
  SchedulePickupUPSResponsePickupOptions.JSON_PROPERTY_PICKUP_END_DATE_TIME,
  SchedulePickupUPSResponsePickupOptions.JSON_PROPERTY_OVERWEIGHT
})
@JsonTypeName("schedulePickupUPSResponse_pickupOptions")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class SchedulePickupUPSResponsePickupOptions {
  ...
  public SchedulePickupUPSResponsePickupOptions() {
  }

  public SchedulePickupUPSResponsePickupOptions pickupStartDateTime(String pickupStartDateTime) {
  ...
  public SchedulePickupUPSResponsePickupOptions pickupEndDateTime(String pickupEndDateTime) {
  ...
  public SchedulePickupUPSResponsePickupOptions overweight(BigDecimal overweight) {
  ...
  public boolean equals(Object o) {
    ...
    SchedulePickupUPSResponsePickupOptions schedulePickupUPSResponsePickupOptions = (SchedulePickupUPSResponsePickupOptions) o;
    return Objects.equals(this.pickupStartDateTime, schedulePickupUPSResponsePickupOptions.pickupStartDateTime) &&
        Objects.equals(this.pickupEndDateTime, schedulePickupUPSResponsePickupOptions.pickupEndDateTime) &&
        Objects.equals(this.overweight, schedulePickupUPSResponsePickupOptions.overweight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pickupStartDateTime, pickupEndDateTime, overweight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SchedulePickupUPSResponsePickupOptions {\n");
