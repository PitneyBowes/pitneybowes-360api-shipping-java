 ...
 */
@JsonPropertyOrder({
  SingleRateResponseParcel.JSON_PROPERTY_HEIGHT,
  SingleRateResponseParcel.JSON_PROPERTY_LENGTH,
  SingleRateResponseParcel.JSON_PROPERTY_WIDTH,
  SingleRateResponseParcel.JSON_PROPERTY_DIM_UNIT,
  SingleRateResponseParcel.JSON_PROPERTY_WEIGHT_UNIT,
  SingleRateResponseParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("singleRateResponse_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class SingleRateResponseParcel {
  ...
  public SingleRateResponseParcel() {
  }

  public SingleRateResponseParcel height(BigDecimal height) {
  ...
  public SingleRateResponseParcel length(BigDecimal length) {
  ...
  public SingleRateResponseParcel width(BigDecimal width) {
  ...
  public SingleRateResponseParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public SingleRateResponseParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public SingleRateResponseParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    SingleRateResponseParcel singleRateResponseParcel = (SingleRateResponseParcel) o;
    return Objects.equals(this.height, singleRateResponseParcel.height) &&
        Objects.equals(this.length, singleRateResponseParcel.length) &&
        Objects.equals(this.width, singleRateResponseParcel.width) &&
        Objects.equals(this.dimUnit, singleRateResponseParcel.dimUnit) &&
        Objects.equals(this.weightUnit, singleRateResponseParcel.weightUnit) &&
        Objects.equals(this.weight, singleRateResponseParcel.weight);
  }
