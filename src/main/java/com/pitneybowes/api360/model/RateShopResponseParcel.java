 ...
 */
@JsonPropertyOrder({
  RateShopResponseParcel.JSON_PROPERTY_HEIGHT,
  RateShopResponseParcel.JSON_PROPERTY_LENGTH,
  RateShopResponseParcel.JSON_PROPERTY_WIDTH,
  RateShopResponseParcel.JSON_PROPERTY_DIM_UNIT,
  RateShopResponseParcel.JSON_PROPERTY_WEIGHT_UNIT,
  RateShopResponseParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("rateShopResponse_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class RateShopResponseParcel {
  ...
  public RateShopResponseParcel() {
  }

  public RateShopResponseParcel height(BigDecimal height) {
  ...
  public RateShopResponseParcel length(BigDecimal length) {
  ...
  public RateShopResponseParcel width(BigDecimal width) {
  ...
  public RateShopResponseParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public RateShopResponseParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public RateShopResponseParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    RateShopResponseParcel rateShopResponseParcel = (RateShopResponseParcel) o;
    return Objects.equals(this.height, rateShopResponseParcel.height) &&
        Objects.equals(this.length, rateShopResponseParcel.length) &&
        Objects.equals(this.width, rateShopResponseParcel.width) &&
        Objects.equals(this.dimUnit, rateShopResponseParcel.dimUnit) &&
        Objects.equals(this.weightUnit, rateShopResponseParcel.weightUnit) &&
        Objects.equals(this.weight, rateShopResponseParcel.weight);
  }
