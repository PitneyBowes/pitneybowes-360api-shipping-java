...
import com.pitneybowes.api360.model.ShipmentInternationalParcel;
 ...
 */
@JsonPropertyOrder({
  ShipmentInternational.JSON_PROPERTY_FROM_ADDRESS,
  ShipmentInternational.JSON_PROPERTY_PARCEL,
  ShipmentInternational.JSON_PROPERTY_CARRIER_ACCOUNT_ID,
  ShipmentInternational.JSON_PROPERTY_PARCEL_TYPE,
  ShipmentInternational.JSON_PROPERTY_SERVICE_ID,
  ShipmentInternational.JSON_PROPERTY_DATE_OF_SHIPMENT,
  ShipmentInternational.JSON_PROPERTY_SPECIAL_SERVICES,
  ShipmentInternational.JSON_PROPERTY_SHIPMENT_OPTIONS,
  ShipmentInternational.JSON_PROPERTY_METADATA,
  ShipmentInternational.JSON_PROPERTY_TO_ADDRESS,
  ShipmentInternational.JSON_PROPERTY_CUSTOMS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class ShipmentInternational {
  ...
  private ShipmentInternationalParcel parcel;
  ...
  public ShipmentInternational fromAddress(ShipmentInternationalFromAddress fromAddress) {
  ...
  public ShipmentInternational parcel(ShipmentInternationalParcel parcel) {
  ...
  public ShipmentInternationalParcel getParcel() {
    return parcel;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PARCEL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParcel(ShipmentInternationalParcel parcel) {
    this.parcel = parcel;
  }

  public ShipmentInternational carrierAccountId(String carrierAccountId) {
  ...
  public ShipmentInternational parcelType(String parcelType) {
  ...
  public ShipmentInternational serviceId(String serviceId) {
  ...
  public ShipmentInternational dateOfShipment(String dateOfShipment) {
  ...
  public ShipmentInternational specialServices(List<SpecialService> specialServices) {
    
    this.specialServices = specialServices;
    return this;
  }

  public ShipmentInternational addSpecialServicesItem(SpecialService specialServicesItem) {
  ...
  public ShipmentInternational shipmentOptions(ShipmentOptions shipmentOptions) {
  ...
  public ShipmentInternational metadata(List<ShipmentInternationalMetadataInner> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public ShipmentInternational addMetadataItem(ShipmentInternationalMetadataInner metadataItem) {
  ...
  public ShipmentInternational toAddress(ShipmentInternationalToAddress toAddress) {
  ...
  public ShipmentInternational customs(ShipmentInternationalCustoms customs) {
  ...
  public boolean equals(Object o) {
    ...
    ShipmentInternational shipmentInternational = (ShipmentInternational) o;
    return Objects.equals(this.fromAddress, shipmentInternational.fromAddress) &&
        Objects.equals(this.parcel, shipmentInternational.parcel) &&
        Objects.equals(this.carrierAccountId, shipmentInternational.carrierAccountId) &&
        Objects.equals(this.parcelType, shipmentInternational.parcelType) &&
        Objects.equals(this.serviceId, shipmentInternational.serviceId) &&
        Objects.equals(this.dateOfShipment, shipmentInternational.dateOfShipment) &&
        Objects.equals(this.specialServices, shipmentInternational.specialServices) &&
        Objects.equals(this.shipmentOptions, shipmentInternational.shipmentOptions) &&
        Objects.equals(this.metadata, shipmentInternational.metadata) &&
        Objects.equals(this.toAddress, shipmentInternational.toAddress) &&
        Objects.equals(this.customs, shipmentInternational.customs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromAddress, parcel, carrierAccountId, parcelType, serviceId, dateOfShipment, specialServices, shipmentOptions, metadata, toAddress, customs);
  }
