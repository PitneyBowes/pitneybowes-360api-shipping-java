 ...
 */
@JsonPropertyOrder({
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_HEIGHT,
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_LENGTH,
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_WIDTH,
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_DIM_UNIT,
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_WEIGHT_UNIT,
  GetAllShipmentsDataInnerParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("getAllShipments_data_inner_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class GetAllShipmentsDataInnerParcel {
  ...
  public GetAllShipmentsDataInnerParcel() {
  }

  public GetAllShipmentsDataInnerParcel height(BigDecimal height) {
  ...
  public GetAllShipmentsDataInnerParcel length(BigDecimal length) {
  ...
  public GetAllShipmentsDataInnerParcel width(BigDecimal width) {
  ...
  public GetAllShipmentsDataInnerParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public GetAllShipmentsDataInnerParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public GetAllShipmentsDataInnerParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    GetAllShipmentsDataInnerParcel getAllShipmentsDataInnerParcel = (GetAllShipmentsDataInnerParcel) o;
    return Objects.equals(this.height, getAllShipmentsDataInnerParcel.height) &&
        Objects.equals(this.length, getAllShipmentsDataInnerParcel.length) &&
        Objects.equals(this.width, getAllShipmentsDataInnerParcel.width) &&
        Objects.equals(this.dimUnit, getAllShipmentsDataInnerParcel.dimUnit) &&
        Objects.equals(this.weightUnit, getAllShipmentsDataInnerParcel.weightUnit) &&
        Objects.equals(this.weight, getAllShipmentsDataInnerParcel.weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAllShipmentsDataInnerParcel {\n");
