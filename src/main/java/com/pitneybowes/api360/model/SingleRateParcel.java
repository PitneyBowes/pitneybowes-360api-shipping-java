 ...
 */
@JsonPropertyOrder({
  SingleRateParcel.JSON_PROPERTY_HEIGHT,
  SingleRateParcel.JSON_PROPERTY_LENGTH,
  SingleRateParcel.JSON_PROPERTY_WIDTH,
  SingleRateParcel.JSON_PROPERTY_DIM_UNIT,
  SingleRateParcel.JSON_PROPERTY_WEIGHT_UNIT,
  SingleRateParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("singleRate_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class SingleRateParcel {
  ...
  public SingleRateParcel() {
  }

  public SingleRateParcel height(BigDecimal height) {
  ...
  public SingleRateParcel length(BigDecimal length) {
  ...
  public SingleRateParcel width(BigDecimal width) {
  ...
  public SingleRateParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public SingleRateParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public SingleRateParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    SingleRateParcel singleRateParcel = (SingleRateParcel) o;
    return Objects.equals(this.height, singleRateParcel.height) &&
        Objects.equals(this.length, singleRateParcel.length) &&
        Objects.equals(this.width, singleRateParcel.width) &&
        Objects.equals(this.dimUnit, singleRateParcel.dimUnit) &&
        Objects.equals(this.weightUnit, singleRateParcel.weightUnit) &&
        Objects.equals(this.weight, singleRateParcel.weight);
  }
