 ...
 */
@JsonPropertyOrder({
  ReprintShipmentParcel.JSON_PROPERTY_HEIGHT,
  ReprintShipmentParcel.JSON_PROPERTY_LENGTH,
  ReprintShipmentParcel.JSON_PROPERTY_WIDTH,
  ReprintShipmentParcel.JSON_PROPERTY_DIM_UNIT,
  ReprintShipmentParcel.JSON_PROPERTY_WEIGHT_UNIT,
  ReprintShipmentParcel.JSON_PROPERTY_WEIGHT
})
@JsonTypeName("reprintShipment_parcel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-30T12:57:37.504069+05:30[Asia/Kolkata]", comments = "Generator version: 7.7.0")
public class ReprintShipmentParcel {
  ...
  public ReprintShipmentParcel() {
  }

  public ReprintShipmentParcel height(BigDecimal height) {
  ...
  public ReprintShipmentParcel length(BigDecimal length) {
  ...
  public ReprintShipmentParcel width(BigDecimal width) {
  ...
  public ReprintShipmentParcel dimUnit(DimUnitEnum dimUnit) {
  ...
  public ReprintShipmentParcel weightUnit(WeightUnitEnum weightUnit) {
  ...
  public ReprintShipmentParcel weight(BigDecimal weight) {
  ...
  public boolean equals(Object o) {
    ...
    ReprintShipmentParcel reprintShipmentParcel = (ReprintShipmentParcel) o;
    return Objects.equals(this.height, reprintShipmentParcel.height) &&
        Objects.equals(this.length, reprintShipmentParcel.length) &&
        Objects.equals(this.width, reprintShipmentParcel.width) &&
        Objects.equals(this.dimUnit, reprintShipmentParcel.dimUnit) &&
        Objects.equals(this.weightUnit, reprintShipmentParcel.weightUnit) &&
        Objects.equals(this.weight, reprintShipmentParcel.weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReprintShipmentParcel {\n");
