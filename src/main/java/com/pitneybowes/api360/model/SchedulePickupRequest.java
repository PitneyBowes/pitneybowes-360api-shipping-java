...
import com.pitneybowes.api360.model.SchedulePickupDHLEXPRequest;
import com.pitneybowes.api360.model.SchedulePickupDHLEXPRequestPickupAddress;
import com.pitneybowes.api360.model.SchedulePickupFedexRequest;
...
import com.pitneybowes.api360.model.SchedulePickupUPSRequest;
import com.pitneybowes.api360.model.SchedulePickupUSPSRequest;
 ...
 */
@JsonPropertyOrder({
  SchedulePickupRequest.JSON_PROPERTY_PACKAGE_LOCATION,
  SchedulePickupRequest.JSON_PROPERTY_CARRIER_ACCOUNT_ID,
  SchedulePickupRequest.JSON_PROPERTY_PICKUP_ADDRESS,
  SchedulePickupRequest.JSON_PROPERTY_SHIPMENT_IDS,
  SchedulePickupRequest.JSON_PROPERTY_PICKUP_SUMMARY,
  SchedulePickupRequest.JSON_PROPERTY_ADDITIONALNOTES,
  SchedulePickupRequest.JSON_PROPERTY_REFERENCE,
  SchedulePickupRequest.JSON_PROPERTY_PICKUP_OPTIONS
})
@JsonTypeName("schedulePickup_request")
...
public class SchedulePickupRequest {
  ...
  public SchedulePickupRequest packageLocation(String packageLocation) {
  ...
  public SchedulePickupRequest carrierAccountId(String carrierAccountId) {
  ...
  public SchedulePickupRequest pickupAddress(SchedulePickupDHLEXPRequestPickupAddress pickupAddress) {
  ...
  public SchedulePickupRequest shipmentIds(List<String> shipmentIds) {
    
    this.shipmentIds = shipmentIds;
    return this;
  }

  public SchedulePickupRequest addShipmentIdsItem(String shipmentIdsItem) {
  ...
  public SchedulePickupRequest pickupSummary(List<SchedulePickupFedexRequestPickupSummaryInner> pickupSummary) {
    
    this.pickupSummary = pickupSummary;
    return this;
  }

  public SchedulePickupRequest addPickupSummaryItem(SchedulePickupFedexRequestPickupSummaryInner pickupSummaryItem) {
  ...
  public SchedulePickupRequest additionalnotes(String additionalnotes) {
  ...
  public SchedulePickupRequest reference(String reference) {
  ...
  public SchedulePickupRequest pickupOptions(SchedulePickupFedexRequestPickupOptions pickupOptions) {
  ...
  public boolean equals(Object o) {
    ...
    SchedulePickupRequest schedulePickupRequest = (SchedulePickupRequest) o;
    return Objects.equals(this.packageLocation, schedulePickupRequest.packageLocation) &&
        Objects.equals(this.carrierAccountId, schedulePickupRequest.carrierAccountId) &&
        Objects.equals(this.pickupAddress, schedulePickupRequest.pickupAddress) &&
        Objects.equals(this.shipmentIds, schedulePickupRequest.shipmentIds) &&
        Objects.equals(this.pickupSummary, schedulePickupRequest.pickupSummary) &&
        Objects.equals(this.additionalnotes, schedulePickupRequest.additionalnotes) &&
        Objects.equals(this.reference, schedulePickupRequest.reference) &&
        Objects.equals(this.pickupOptions, schedulePickupRequest.pickupOptions);
  }
